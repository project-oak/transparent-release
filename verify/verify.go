...
func (verifier *ReproducibleProvenanceVerifier) Verify(provenanceFilePath string) error {
	...
	// cleanup
	if tempFolder != "" {
		// Some of the files are generated by cargo, and cannot be removed. We
		// want to remove the other files to avoid taking up too much space,
